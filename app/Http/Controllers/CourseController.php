...
class CourseController extends Controller
{
    ...
    {
        // mendapatkan seluruh data kelas
    ...
    public function store(StoreCourseRequest $request)
    {
        ...
        DB::transaction(function () use ($request, $teacher) {
            ...
            $validated['about'] = $request->has('about') ? $request->input('about') : null;
    ...
    public function destroy(Course $course)
    {
        ...
        try {
            ...
            DB::rollBack();
            return redirect()->route('admin.courses.index')->with('error', 'Terjadi Sebuah Kesalahan');
        } 
    }
}
